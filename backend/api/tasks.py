...
def clean_excel_string(s):
    ...
    # Удаляем символы, которые нельзя использовать в Excel (НО сохраняем слэши / для названий)
    # Слэши важны для правильного отображения названий типа "NISSAN/HINO/FUSO"
