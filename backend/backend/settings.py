...
CELERY_TASK_TIME_LIMIT = 86400  # Максимальное время выполнения задачи (24 часа) - соответствует настройкам в tasks.py
CELERY_TASK_SOFT_TIME_LIMIT = 82800  # Мягкий лимит (23 часа) - соответствует настройкам в tasks.py
