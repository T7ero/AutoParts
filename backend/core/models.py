...
class CrossReference(models.Model):
    ...
    cross_article = models.CharField(max_length=100, default='', verbose_name="Кросс-артикул")
    cross_brand = models.CharField(max_length=100, default='', verbose_name="Кросс-бренд")
    source = models.CharField(
    max_length=20, 
    choices=ParsingTask.SOURCE_CHOICES, 
    blank=True, 
    null=True,
